...
static KMap _keyCodesMap(
    ...
    KEY_NAME_PAIR(UNDEFINED_001),
    KEY_NAME_PAIR(UNDEFINED_002),
    KEY_NAME_PAIR(UNDEFINED_003),
    KEY_NAME_PAIR(UNDEFINED_004),
    KEY_NAME_PAIR(UNDEFINED_005),
    KEY_NAME_PAIR(UNDEFINED_006),
    KEY_NAME_PAIR(UNDEFINED_007),
    KEY_NAME_PAIR(A),
    KEY_NAME_PAIR(B),
    KEY_NAME_PAIR(C),
    KEY_NAME_PAIR(D),

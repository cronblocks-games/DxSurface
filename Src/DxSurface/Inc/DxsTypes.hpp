...
namespace CB::DxSurface {
  ...
  enum class KeyCode : unsigned char
  {
    ...
    __Reserved_001 = 0x07,          // 0x07 - Reserved
    BackSpace = VK_BACK,            // 0x08 - BACKSPACE key
    Tab = VK_TAB,                   // 0x09 - TAB key
    __Reserved_002 = 0x0A,          // 0x0A - Reserved
    __Reserved_003 = 0x0B,          // 0x0B - Reserved
    Clear = VK_CLEAR,               // 0x0C - CLEAR key
    Enter = VK_RETURN,              // 0x0D - ENTER key
    Return = Enter,                 // 
    __Unassigned_001 = 0x0E,        // 0x0E - Unassigned
    __Unassigned_002 = 0x0F,        // 0x0F - Unassigned
    ...
    Digit9 = Num9,                  // 
    __Undefined_001 = 0x3A,         // 0x3A-0x40 - Undefined
    __Undefined_002 = 0x3B,         // 
    __Undefined_003 = 0x3C,         // 
    __Undefined_004 = 0x3D,         // 
    __Undefined_005 = 0x3E,         // 
    __Undefined_006 = 0x3F,         // 
    __Undefined_007 = 0x40,         // 
    A = 0x41,                       // 0x41 - A key
    B = 0x42,                       // 0x42 - B key
    C = 0x43,                       // 0x43 - C key
    D = 0x44,                       // 0x44 - D key
    ...
    __Reserved_004 = 0x5E,          // 0x5E - Reserved
    ...
    __Reserved_005 = 0x88,          // 0x88-0x8F - Reserved
    __Reserved_006 = 0x89,          // 
    __Reserved_007 = 0x8A,          // 
    __Reserved_008 = 0x8B,          // 
    __Reserved_009 = 0x8C,          // 
    ...
    __Unassigned_003 = 0x97,        // 0x97-0x9F - Unassigned
    __Unassigned_004 = 0x98,        // 
    __Unassigned_005 = 0x99,        // 
    __Unassigned_006 = 0x9A,        // 
    __Unassigned_007 = 0x9B,        // 
    __Unassigned_008 = 0x9C,        // 
    __Unassigned_009 = 0x9D,        // 
    __Unassigned_010 = 0x9E,        // 
    __Unassigned_011 = 0x9F,        // 
    ...
    __Reserved_013 = 0xB8,                           // 0xB8-0xB9 - Reserved
    __Reserved_014 = 0xB9,                           // 
    ...
    __Reserved_015 = 0xC1,                           // 0xC1-0xDA - Reserved
    __Reserved_016 = 0xC2,                           // 
    __Reserved_017 = 0xC3,                           // 
    __Reserved_018 = 0xC4,                           // 
    __Reserved_019 = 0xC5,                           // 
    ...
    __Reserved_041 = 0xE0,                           // 0xE0 - Reserved
    ...
    __Unassigned_012 = 0xE8,                         // 0xE8 - Unassigned
